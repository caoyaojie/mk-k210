...
devices = os.listdir("/")
if "sd" in devices:   #cyj modify sd to sdd boot from flash 2019-8-29
    os.chdir("/sd")
    sys.path.append('/sd')
else:
    os.chdir("/flash")
...
try:
    ...
    pass
print("I2s init over")  #cyj add 2019-9-20
...
print("button init over")  #cyj add 2019-9-20
...
print("led init over")  #cyj add 2019-9-20
import sensor
import KPU as kpu
...
while 1:
    try:
        ...
        time.sleep(0.1)
        continue
print("sensor reset over")  #cyj add 2019-9-20
sensor.set_pixformat(sensor.RGB565)
sensor.set_framesize(sensor.QVGA) #QVGA=320x240
sensor.run(1)
print("begin to task kpu load")
...
print("begin to task kpu init yolo2")
kpu.init_yolo2(task, 0.5, 0.3, 5, anchor)

but_stu = 1
print("begin kpu.run_yolo2")  #cyj add 2019-9-20
try:
    while(True):
