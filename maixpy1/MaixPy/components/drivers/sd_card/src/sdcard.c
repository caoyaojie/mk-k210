...
uint8_t sd_init(void)
{
	...
	cardinfo.active = 0;
        // cyj add 2019-8-27 config sd card spi wei 26 to 29pin,2019-9-6 repeat
	#ifdef CONFIG_BOARD_M5STICK
                //cyj add for m5stick config 2019-9-11
             
		fpioa_set_function(30, FUNC_SPI1_SCLK);
		fpioa_set_function(33, FUNC_SPI1_D0);  //old is 33
		fpioa_set_function(31, FUNC_SPI1_D1);  //old is 31
		fpioa_set_function(32, FUNC_GPIOHS0 + SD_CS_PIN);
		// fpioa_set_function(25, FUNC_SPI0_SS0 + SD_SS);

                //cyj add for maixduino config 2019-9-11
                /*
		...
		fpioa_set_function(28, FUNC_SPI1_D1);
		fpioa_set_function(29, FUNC_GPIOHS0 + SD_CS_PIN);*/
		// fpioa_set_function(25, FUNC_SPI0_SS0 + SD_SS);
