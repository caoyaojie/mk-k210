...
int video_play_avi_init(const char* path, avi_t* avi)
{
    ...
    int err;
    // uint32_t offset;
    //cyj addj 2019-9-3 play avi begin at here
    printk("video_play_avi_init function  begin \r\n");
    ...
    printk("video_play_avi_init --video_hal_malloc ok \r\n");
    ...
    printk("video_play_avi_init --vfs_internal_open ok \r\n");
    avi->file = (void*)file;
    ...
    printk("video_play_avi_init --vfs_internal_read ok \r\n");
    ...
    printk("video_play_avi_init --avi_init ok \r\n");
    //stream
    ...
    printk("video_play_avi_init --avi_get_streaminfo ok \r\n");
    ...
    // cyj modify 2019-9-16
    printk("video_play_avi_init --vfs_internal_seek ok \r\n");
    avi->video_buf = buf;
    avi->frame_count = 0;
