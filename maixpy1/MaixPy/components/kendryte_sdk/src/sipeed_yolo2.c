...
#include "printf.h"  //cyj add 2019-10-3
...
{
    //cyj add 2019-10-8
    //mp_printf(&mp_plat_print, "region_layer_run: start run!\r\n");
    printk("region_layer_run: start run \r\n");  //cyj add 2019-10-7 
    
    forward_region_layer(rl);
    //cyj add 2019-10-8
     printk("region_layer_run: start run1 \r\n");  //cyj add 2019-10-7 
    
    get_region_boxes(rl, rl->output, rl->probs, rl->boxes);
    //cyj add 2019-10-8
     printk("region_layer_run: start run2 \r\n");  //cyj add 2019-10-7 
    do_nms_sort(rl, rl->boxes, rl->probs);
    //cyj add 2019-10-8
     printk("region_layer_run: start run3 \r\n");  //cyj add 2019-10-7 
